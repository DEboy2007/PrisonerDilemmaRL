...
class OpponentHistory:
    ...
    Starts with optimistic prior: assumes opponent shares 80% of the time.
    """
    def __init__(self, initial_share_rate=0.8):
    ...
    def get_state_vector(self):
        ...
        If no history, uses optimistic prior (20% steal rate).
        ...
        if len(self.history) == 0:
            # Optimistic prior: assume opponent mostly shares
            # Fill all bins with prior belief
...
class DQNPrisoner:
    ...
    Starts with optimistic belief that opponent shares 80% of the time.
    """
    def __init__(self, learning_rate=0.001, discount_factor=0.9, initial_epsilon=0.5, optimistic_prior=0.8):
        self.net_money = 0
        ...
        # Track opponent's history with optimistic prior
...
if __name__ == "__main__":
    print("=" * 70)
    print("DQN Prisoner's Dilemma - Optimistic Start (80% Share Prior)")
    print("=" * 70)

    # Create two learning prisoners with optimistic prior
    p1 = DQNPrisoner(learning_rate=0.001, discount_factor=0.9, initial_epsilon=0.5, optimistic_prior=0.8)
    p2 = DQNPrisoner(learning_rate=0.001, discount_factor=0.9, initial_epsilon=0.5, optimistic_prior=0.8)
    ...
    print(f"**OPTIMISTIC PRIOR: Agents start believing opponent shares 80% of time**\n")
